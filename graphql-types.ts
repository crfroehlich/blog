...
export type GetPageByIdQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'docsLocation'>> }>, mdx?: Maybe<(
    ...
    & { fields?: Maybe<Pick<MdxFields, 'id' | 'title' | 'slug' | 'date' | 'tags' | 'img'>>, parent?: Maybe<Pick<File, 'relativePath'>> }
  )>, allMdx: { edges: Array<{ node: { fields?: Maybe<Pick<MdxFields, 'id' | 'title' | 'slug' | 'date'>>, parent?: Maybe<Pick<File, 'relativePath'>> } }>, group: Array<Pick<MdxGroupConnection, 'fieldValue' | 'totalCount'>> } };
